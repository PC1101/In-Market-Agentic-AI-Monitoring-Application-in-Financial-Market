...
def main():
    ...
    log.info("=== JT Momentum LONG-ONLY — S&P ASX 200 C&P ===")
    ...
    axes[0].set_title(
        f"ASX 200  |  JT Momentum 12-1  LONG-ONLY  |  "
