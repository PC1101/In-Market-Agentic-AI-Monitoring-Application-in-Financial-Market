"""
run_al_longonly.py — AL PCA Stat Arb LONG-ONLY for S&P 500 C&P (Norgate).
...
Outputs: USEquities/results/al_longonly/
"""
...
def main():
    ...
    log.info("=== AL PCA Stat Arb LONG-ONLY — S&P 500 C&P ===")
    ...
    axes[0].set_title(
        f"S&P 500  |  AL PCA Stat Arb  LONG-ONLY  |  "
